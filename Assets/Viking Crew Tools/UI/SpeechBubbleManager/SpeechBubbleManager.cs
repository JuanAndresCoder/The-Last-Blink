...
namespace VikingCrew.Tools.UI {
    public class SpeechBubbleManager : MonoBehaviour
    {
        ...
        public SpeechBubbleBase AddSpeechBubble(Vector3 position, string text, SpeechbubbleType type = SpeechbubbleType.NIETO, float timeToLive = 0, Color color = default(Color))
        {
        ...
        public SpeechBubbleBase AddSpeechBubble(Transform objectToFollow, string text, SpeechbubbleType type = SpeechbubbleType.NIETO, float timeToLive = 0, Color color = default(Color), Vector3 offset = new Vector3())
        {
            if (timeToLive == 0) timeToLive = _defaultTimeToLive;
            if (color == default) color = _defaultColor;
        ...
        public void AddDelayedSpeechBubble(float delay, Transform objectToFollow, string text, SpeechbubbleType type = SpeechbubbleType.NIETO, float timeToLive = 0, Color color = default(Color), Vector3 offset = new Vector3())
        {
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        private SpeechBubbleBase GetBubble(SpeechbubbleType type = SpeechbubbleType.NIETO)
        {
